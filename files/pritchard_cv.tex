...
\begin{document}  
\name{\hspace{0.05in} Nathaniel Pritchard \\  \hspace{0.45in} September 2025}
...
\section{RESEARCH EMPLOYMENT}
		 {\bf University of Oxford}, \hfill Oxford, United Kingdom\\
                ...
                Topic: Certifying accuracy of randomised algorithms in numerical linear algebra
...
\section{SOFTWARE}
\textbf{RLinearAlgebra (Co - Developer):}  A Julia Package for prototyping and benchmarking Randomized Linear Algebra algorithms.\\
